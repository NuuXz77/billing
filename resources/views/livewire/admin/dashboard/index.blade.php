<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div wire:click="navigateToUsers" class="group transition-all duration-300 cursor-pointer">
            <div class="card bg-base-100 border border-base-300 transition-all duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/20 group-hover:-translate-y-1">
                <div class="card-body">
        ...
        <div wire:click="navigateToTransactions('active')" class="group transition-all duration-300 cursor-pointer">
            <div class="card bg-base-100 border border-base-300 transition-all duration-300 hover:border-success/30 hover:shadow-xl hover:shadow-success/20 hover:-translate-y-1 cursor-pointer">
                <div class="card-body">
                    <div class="flex items-center justify-between mb-4">
        ...
        <div wire:click="navigateToPayments" class="group transition-all duration-300 cursor-pointer">
            <div class="card bg-base-100 border border-base-300 transition-all duration-300 hover:border-warning/30 hover:shadow-xl hover:shadow-warning/20 hover:-translate-y-1 cursor-pointer">
                <div class="card-body">
                    <div class="flex items-center justify-between mb-4">
        ...
        <div wire:click="navigateToTransactions('pending')" class="group transition-all duration-300 cursor-pointer">
            <div class="card bg-base-100 border border-base-300 transition-all duration-300 {{ $pendingInvoices > 0 ? 'hover:border-error/30 hover:shadow-xl hover:shadow-error/20' : 'hover:border-neutral/30 hover:shadow-xl hover:shadow-neutral/20' }} hover:-translate-y-1 cursor-pointer">
                <div class="card-body">
                    <div class="flex items-center justify-between mb-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4">
        <div class="lg:col-span-2 card bg-base-100 border border-base-300 transition-all duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/15 hover:-translate-y-1">
            <div class="card-body">
        ...
        <div class="card bg-base-100 border border-base-300 transition-all duration-300 hover:border-info/30 hover:shadow-xl hover:shadow-info/15 hover:-translate-y-1 cursor-pointer">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
        <div class="card bg-base-100 border border-base-300 transition-all duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/15 hover:-translate-y-1">
            <div class="card-body">
        ...
        <div class="card bg-base-100 border border-base-300 transition-all duration-300 hover:border-success/30 hover:shadow-xl hover:shadow-success/15 hover:-translate-y-1 cursor-pointer">
            <div class="card-body">
    ...
    <div class="grid grid-cols-1 gap-4 mt-4">
        <div class="card bg-base-100 border border-base-300 transition-all duration-300 hover:border-warning/30 hover:shadow-xl hover:shadow-warning/15 hover:-translate-y-1 cursor-pointer">
            <div class="card-body">
