...
<div class="modal" role="dialog">
    <div class="modal-box max-w-3xl max-h-[90vh] overflow-y-auto no-scrollbar">
        ...
        <div class="flex items-center justify-between mb-6 pb-4 border-b border-base-300">
            <div>
                <h3 class="text-xl font-bold">Edit Metode Pembayaran</h3>
                <p class="text-sm text-neutral mt-1">Perbarui informasi metode pembayaran</p>
            </div>
        ...
        <form wire:submit="updatePayment">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-control">
                    <label class="input w-full">
                        ...
                        <input wire:model="payment_code" type="text" placeholder="Kode pembayaran" required />
                    </label>
                    @error('payment_code')
            ...
            <div class="modal-action pt-6 border-t border-base-300">
                ...
                <button type="submit" class="btn btn-warning" wire:loading.attr="disabled">
                    ...
                    <span wire:loading.remove">Update Metode</span>
