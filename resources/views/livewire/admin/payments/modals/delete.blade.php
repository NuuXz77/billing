...
<div class="modal" role="dialog">
    <div class="modal-box max-w-md">
        ...
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-xl font-bold text-error">Hapus Metode Pembayaran</h3>
        ...
        <div class="flex flex-col items-center text-center space-y-4">
            ...
            <div class="space-y-2">
                ...
                <div class="alert alert-warning">
                    ...
                    <div class="text-sm">
                        <strong>Peringatan:</strong> Metode pembayaran yang memiliki transaksi aktif tidak dapat dihapus. 
            ...
            <div class="text-xs text-base-content/60 space-y-1">
                <p>• Data metode pembayaran akan dihapus permanen</p>
        ...
        <div class="modal-action pt-6 border-t border-base-300">
            ...
            <button wire:click="deletePayment" class="btn btn-error" wire:loading.attr="disabled">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
