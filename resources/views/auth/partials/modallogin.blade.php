...
<div x-show="showModal" 
        ...
        <div class="alert alert-success shadow-lg animate-bounce-in">
            <div class="flex items-start w-full">
                ...
                <div class="flex-1 ml-3">
                    <h3 class="font-bold text-sm">Login Berhasil!</h3>
                    <div class="text-xs mt-1" x-text="modalMessage"></div>
                    <div class="text-xs mt-2 opacity-70">Mengalihkan ke dashboard...</div>
                </div>
    ...
    <template x-if="modalType === 'error'">
        <div class="alert alert-error shadow-lg animate-shake">
            ...
            <div class="absolute bottom-0 left-0 h-1 bg-error-content animate-progress"></div>
        </div>
    </template>
</div>
